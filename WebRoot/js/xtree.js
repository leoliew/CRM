...
var webFXTreeConfig = {
        rootIcon        : '../images/tubiao01.gif',
        openRootIcon    : '../images/tubiao02.gif',
        folderIcon      : '../images/tubiao01.gif',
        openFolderIcon  : '../images/tubiao02.gif',
        fileIcon        : '../images/tubiao03.gif',
        iIcon           : '../images/I.gif',
        lIcon           : '../images/L.gif',
        lMinusIcon      : '../images/Tminus.gif',
        lPlusIcon       : '../images/Tplus.gif',
        tIcon           : '../images/T.gif',
...
WebFXTree.prototype.toString = function() {
        ...
        str += "<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"webFXTreeHandler.select(this);\"><a href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\" title=\""+ this.text +"\">" + this.text + "</a></div>";
...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
        ...
        str += "<img id=\"" + this.id + "-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"webFXTreeHandler.select(this);\"><a href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\" title=\""+ label +"\">" + label + "</a></div>";
        str += "<div id=\"" + this.id + "-cont\" class=\"webfx-tree-container\" style=\"display: " + ((this.open)?'block':'none') + ";\">";
        for (var i = 0; i < this.childNodes.length; i++) {
                str += this.childNodes[i].toString(i,this.childNodes.length);
        }
