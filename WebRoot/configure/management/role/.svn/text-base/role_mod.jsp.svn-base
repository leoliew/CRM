...
var inputAction ="roleManagerAction.do";
//设置命令
...
<body vlink=#000000 alink=#000000 link=#000000 bgColor=#ffffff onLoad="document.roleManageActionForm.roleName.focus()">
  <!-- 栏目添加部分开始 -->
  <form action="roleManagerAction!mod.action" method="post" name="roleManagerActionForm">
				...
				<td width="100%">
				  <table border="0" cellspacing="1" cellpadding="2" bgcolor="#CADADF" width="100%">
					<tr bgcolor="#F4F7FA">
					  ...
					  <td width="30%">
                           <input type="text"  maxlength="20"  name="roleName" onkeydown="enterToTab()" size="20" value="${requestScope.role.roleName}"/><font color="#FF0000">(必填)</font>
					  </td>
					  </tr>
					  <tr bgcolor="#F4F7FA">
					  <td align="right" width="20%">角色说明：</td>
					  <td width="30%">
					  <input type="text" maxlength="100"  name="roleDesc" size="50" value="${requestScope.role.roleDesc}"/>
					  </td>
					</tr>
					<tr bgcolor="#F4F7FA">
